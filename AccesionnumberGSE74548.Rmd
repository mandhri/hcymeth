...
make_heatmap(dm=dma3a , name="hcy_levels(sex,age)" , mx=mxs ,n = 50, groups=groups)
...
```{r,venn3]2,fig.cap="Comparison of probes in related to hcy(sex) vs folate level(sex,age)", fig.width = 8 ,fig.height = 8}
...
head(v2)
str(v2)
plot(euler(23, shape = "ellipse"), quantities = TRUE)
