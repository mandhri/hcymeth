...
#aqsk from dr mark as to why its not working
v4 <- list("fol(up)" =dm4b_u, 
           "hcy(up)" =dm3bb_u,
           "fol(dwn)" =dm4b_d,
           "hcy(dwn)" =dm3bb_d)
head(v4)
plot(euler(v4, shape = "ellipse"), quantities = FALSE)
```




```{r,venn5,fig.cap="Comparison of probes in related to hcy(age) vs folate level(sex,age)", fig.width = 8 ,fig.height = 8}
v5 <- list("plb v sup fl(up)" =dm1b_u, 
           "fol(up)" = dm4b_u ,
           "plb v sup fl(dwn)" =dm1b_d ,
           "fol(dwn)" =dm4b_d)
head(v5)
...
mycontrasts <- list("placebo vs supplement follow-up(sex,age)_up"=dm1a_u, "placebo vs supplement follow-up(sex,age)_dwn"=dm1a_d,"placebo vs supplement Baseline(sex,age)_dwn"=dm2a_d,"placebo vs supplement Baseline(sex,age)_up"=dm2a_u,"hcy levels(sex,age)_dwn"=dm3b_d,"hcy levels(sex,age)_up"=dm3b_u,"folate levels(sex,age)_dwn"=dm4b_d,"folate levels(sex,age)_up"=dm4b_u,"vitb12 levels(sex,age"=dm5b_d,"vitb12 levels(sex,age"=dm5b_u)
