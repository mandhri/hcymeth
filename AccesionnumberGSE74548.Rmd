...
```{r,venn1,fig.cap="Comparison of probes in related to placebo vs supplement in follow-up(sex included)", fig.width = 8 ,fig.height = 8}
...
```
```{r,venn2,fig.cap="Comparison of probes in related to placebo vs supplement in baseline(sex,age)", fig.width = 8 ,fig.height = 8}
v2 <- list("plb v sup bsl(up)" =dm2a_u , 
           "hcy(up)" =dm3a_d ,
           "plb v sup bsl(dwn)" =dm2a_d ,
           "hcy(dwn)" =dm3b_d)
head(v2)
plot(euler(v2, shape = "ellipse"), quantities = TRUE)
```
```{r,venn3,fig.cap="Comparison of probes in related to placebo vs supplement in baseline(sex,age)", fig.width = 8 ,fig.height = 8}
v3 <- list("plb v sup bsl(up)" =dm2a_u , 
           "hcy(up)" =dm3a_d ,
           "plb v sup bsl(dwn)" =dm2a_d ,
           "hcy(dwn)" =dm3b_d,
           "plb v sup fl(up)" =dm1a_u ,
           "plb v sup fl(dwn)" =dm1a_d)
head(v3)
