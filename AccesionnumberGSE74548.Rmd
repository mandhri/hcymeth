...
heatmap_c<-function(dm,name,mx,n, groups) {
  ...
  my_palette <- colorRampPalette(c("white","yellow", "orange", "red","darkred"))(n = 25)
  colCols <- as.numeric(groups)
  colCols <- gsub("0.6666667","purple",colCols)
  colCols <- gsub("0.3333333","blacke",colCols)
  colCols <- gsub("1.0000000","blue",colCols)
...
groups
make_heatmap2(confects = confects , name="hcy_levels(sex,age)",mx=mxs ,n = 50, groups=groups)
```
